        ...
        if (isset($_POST['name'])) {
            if (isset($_POST['agree'])) {
                ...
                if ($password==$c_password) {
                    ...
                    if ($row_user_admin<1) {
                        $insert_user_admin=mysqli_query($con,"INSERT INTO `admin_user`( `name`, `email`, `phone`, `control`, `description`, `password`,`user_type`) VALUES ('$name','$email','$phone','$control','$description','$password',' $user_type')");
