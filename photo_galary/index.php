...
<head>
	...
	<title>Photo Galary || <?php echo mysqli_fetch_assoc($con->query("SELECT * FROM `web_title` WHERE `type`='full'"))['title']; ?></title>
	<?php 
...
<body>
	...
	<div class="container-fulid pt-3">
		<?php if (file_exists('photo_galary.php')) {
			require_once 'photo_galary.php';
		} ?>
	</div>
