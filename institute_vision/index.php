...
<head>
	...
	<title>Vision & Info || <?php echo mysqli_fetch_assoc($con->query("SELECT * FROM `web_title` WHERE `type`='full'"))['title']; ?></title>
	<?php 
...
<body>
	...
	<div class="container-fulid pt-3">
		<?php if (file_exists('ins_vision.php')) {
			require_once 'ins_vision.php';
		} ?>
	</div>

	<?php 	/*if (file_exists("../suscriber/index.php")) {
				require_once '../suscriber/index.php';
			}else{
				echo "file_not exist";
			}*/
